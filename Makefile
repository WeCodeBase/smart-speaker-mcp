...
build: vet
	CGO_ENABLED=0 $(GO_BUILD) -o smart-speaker-mcp .
...
build-all: clean
	mkdir -p dist
	CGO_ENABLED=0 GOOS=darwin  GOARCH=arm64 $(GO_BUILD) -o dist/smart-speaker-mcp-darwin-arm64 .
	CGO_ENABLED=0 GOOS=darwin  GOARCH=amd64 $(GO_BUILD) -o dist/smart-speaker-mcp-darwin-amd64 .
	CGO_ENABLED=0 GOOS=windows GOARCH=amd64 $(GO_BUILD) -o dist/smart-speaker-mcp-windows-amd64.exe .
	CGO_ENABLED=0 GOOS=linux   GOARCH=amd64 $(GO_BUILD) -o dist/smart-speaker-mcp-linux-amd64 .
	CGO_ENABLED=0 GOOS=linux   GOARCH=arm64 $(GO_BUILD) -o dist/smart-speaker-mcp-linux-arm64 .
